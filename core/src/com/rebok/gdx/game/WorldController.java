...
public class WorldController extends InputAdapter{
	...
	public Sprite[] testSprites; //Test sprites
	public int selectedSprite; //Currently selected sprite
