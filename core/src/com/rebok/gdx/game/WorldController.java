...
public class WorldController extends InputAdapter implements Disposable{
	...
	private boolean goalReached; //if the goal was reached
	public World b2world; //physics
	
	private boolean accelerometerAvailable; //android?
